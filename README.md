Mockup of a fashion retail website's product detail page. Single page application that re renders depending on the product data and related meta-data it receives
